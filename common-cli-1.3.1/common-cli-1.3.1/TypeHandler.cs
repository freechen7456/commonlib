...
namespace org.apache.commons.cli
{
    ...
    public class TypeHandler
    {
        ...
        {
            return createValue(str, (Type)obj);
        }
        ...
        public static object createObject(string classname)
        {
            ...
            try
            {
                System.Reflection.ConstructorInfo constructor = cl.GetConstructor(Type.EmptyTypes);
                if (constructor != null)
                {
         ...
         */
        public static ValueType createNumber(string str)
        {
            try
            {
                if (str.IndexOf('.') != -1)
